...
def main():
    ...
    # parser.add_argument('-i', '--input', type=str, default='inputs_segment', help='Input image or folder')
    parser.add_argument('-i', '--input', type=str, default=r'', help='Input image or folder')
    # parser.add_argument(
    #     '-n',
    #     '--model_name',
    #     type=str,
    ...
    for idx, path in enumerate(paths):
        ...
        try:
            ...
            import tifffile as tif    # ----------------------------添加-------------------------------------------------------
            tif.imwrite(save_path, output) # cv2.imwrite(save_path, output)   # ---------------------------------------------
