...
def main(args):
    ...
    for img_path_gt, img_path_lq in zip(img_paths_gt, img_paths_lq):
        ...
        img_name_gt = img_path_gt
        img_name_lq = img_path_lq
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--input',
        nargs='+',
        default=['/home/xiaoran/project/small_bodies_data/HR_Train_1', '/home/xiaoran/project/small_bodies_data/LR_Train_1'],
    ...
    parser.add_argument(
        '--meta_info',
        type=str,
        default='/home/xiaoran/project/small_bodies_data/meta_info_ESRGAN_small_bodies_sub_pair_1.txt',
