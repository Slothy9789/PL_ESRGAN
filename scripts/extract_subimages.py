...
if __name__ == '__main__':
    ...
    parser.add_argument('--input', type=str, default=R'E:\Doctor\2023.8_ESRGAN\Real-ESRGAN-master\datasets\Mars\Train_multiscale', help='Input folder')
    parser.add_argument('--output', type=str, default=R'E:\Doctor\2023.8_ESRGAN\Real-ESRGAN-master\datasets\Mars\Train_multiscale_sub', help='Output folder')
